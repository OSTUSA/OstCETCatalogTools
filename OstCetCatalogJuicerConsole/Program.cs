...
namespace OstCetCatalogJuicerConsole
{
    class Program
    {
        private static string _dbConnectionString = "Data Source=C:\\Users\\Johnnie\\Documents\\CET Documents\\Intrinsic\\INR.db3";

        static async Task Main(string[] args)
        {
            await RunMaterialTransfer();
        }
        ...
        public static async Task RunMaterialTransfer()
        {
            const string copyTo = "Data Source=C:\\Users\\Johnnie\\Documents\\CET Documents\\Trig\\TRG.db3";
