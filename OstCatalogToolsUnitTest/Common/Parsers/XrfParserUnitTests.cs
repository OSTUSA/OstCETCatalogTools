...
using OstToolsCommon.Parsers;
using Xunit;

namespace OstCatalogToolsUnitTest.Common.Parsers
{
    public class XrfParserUnitTests
    {
        ...
        /// </summary>
        private readonly string _xrfPath = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) ?? string.Empty, @"Common/Parsers/XRF.TXT");
