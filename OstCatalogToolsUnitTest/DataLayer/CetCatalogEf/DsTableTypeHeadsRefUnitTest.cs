...
{
    public class DsTableTypeHeadsRefUnitTest : CatalogBaseUnitTest
    {
        [Fact]
        public async Task ToListAsync_Void_NotEmpty()
        {
            var list = await CetCatalogContext.DsTableTypeHeadsRefs.ToListAsync();
        ...
        {
            var first = await CetCatalogContext.DsTableTypeHeadsRefs
                .Include(r => r.Owner)
                .Include(r => r.Child)
                .FirstOrDefaultAsync();
